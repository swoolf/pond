...
saver = tf.train.import_meta_graph('/cluster/home/swoolf02/Autopilot-TensorFlow/save/model.ckpt.meta')
saver.restore(sess,tf.train.latest_checkpoint('/cluster/home/swoolf02/Autopilot-TensorFlow/save/'))
...
for epoch in range(epochs):
  for i in range(int(driving_data.num_images/batch_size)):
    ...
    if i % 10 == 0:
      vxs, vys = driving_data.LoadValBatch(batch_size)
